...
#### 请求方式
- **方法**: POST
- **URL**: https://obai.ipolloverse.cn/iPollo/twinSync/phototalking
...
```json
{
  "text": "",         #口述文本，不得超过150字
  "image_url": "",    #照片文件的云地址
  "pronouncer": "",   #从Microsoft TTS中选择的发音人
  "btc_address": ""   #BTC地址
}
```
- text: 口述文本，不得超过150字
...
- **方法**: GET
- **URL**: https://obai.ipolloverse.cn/iPollo/twinSync/phototalking?taskID=xxx
